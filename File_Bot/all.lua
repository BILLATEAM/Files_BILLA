...
if database:get(bot_id.."SSSSSSY:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"*انتظر دقيقه من فضلك*")
end
database:setex(bot_id..'SSSSSSY:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
