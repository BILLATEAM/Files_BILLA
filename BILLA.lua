...
SUDO = SUDO
sudo_users = {SUDO,1757836235,1033028167}   
print([[
> CH › @EE28i
> CH › @EE92i
~> DEVELOPER › @EE66i
...
--------------------------------------------------------------------------------------------------------------
function SourceBILLA(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
if text == 'ضع كليشه ستارت ✹' and DevBILLAW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✹︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✹' and DevBILLAW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✹︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✹' and DevBILLAW(msg) then 
...
send(msg.chat_id_, msg.id_,' *✹︙تم تحديث السورس* \n*✹︙لديك اخر اصدار لسورس بيلا*\n*✹︙الاصدار » { 2.8v}*')
dofile('BILLA.lua')  
end
if text == 'الاصدار ✹' and DevBILLAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✹︙اصدار سورس بيلا* \n*✹︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✹' and DevBILLAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✹︙[تحديثات البوت](t.me/EE92i) \n✹︙[قناه السورس](t.me/EE28i)')
end
if text == "ضع اسم للبوت ✹" and DevBILLAW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *✹︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✹' and DevBILLAW(msg) then 
...
if text == 'المشتركين ✹' and DevBILLAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✹︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✹' and DevBILLAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✹︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("قائمه الكتم العام ✹") and DevBILLAW(msg) then
...
if text=="اذاعه خاص ✹" and msg.reply_to_message_id_ == 0 and DevBILLAW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✹︙ارسل الان اذاعتك؟* \n*✹︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✹" and msg.reply_to_message_id_ == 0 and DevBILLAW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✹︙ارسل الان اذاعتك؟* \n*✹︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✹" and msg.reply_to_message_id_ == 0 and DevBILLAW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✹︙ارسل الان اذاعتك؟* \n*✹︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✹" and msg.reply_to_message_id_ == 0  and DevBILLAW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✹︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✹" and msg.reply_to_message_id_ == 0  and DevBILLAW(msg) then 
...
send(msg.chat_id_, msg.id_,'*✹︙عدد الكروبات الان » { '..#group..' }'..BILLAk..''..BILLA..'*\n*✹︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
usertext = '*\n ✹︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'EE28i')..')'
status  = '\n *✹︙تم ترقيته مطور*'
...
usertext = '\n *✹︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'EE28i')..')'
status  = '\n*✹︙تم ترقيته مطور*'
...
if BILLA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✹︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'EE28i')..') \n ✹︙'..BILLA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
send(msg.chat_id_,0," *✹︙العضو :* {["..data.first_name_.."](T.ME/EE28i)}\n✹︙["..BILLA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
if text == "حذف رساله الاشتراك ✹" and DevBILLAW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✹︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✹$") and DevBILLAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✹︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✹" and DevBILLAW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ✹" and DevBILLAW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✹︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✹" and DevBILLAW(msg) then  
...
send(msg.chat_id_, msg.id_, "✹︙عزيزي >>["..BILLA2.username_.."](https://t.me/"..(BILLA2.username_ or "EE28i")..")\n✹︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."BILLA:teh"..msg.chat_id_).."} بجانب اسمك\n✹︙عدد المحاولات المتبقيه {"..(tonumber(BILLA_nnn) - tonumber(BILLA_nnn2)).."}")
end
end
end
end
...
send(msg.chat_id_, msg.id_, '*✹︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'EE28i')..') \n*✹︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✹︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'EE28i')..') \n*✹︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
if Get_info then
local TextS = "\n *✹︙اهلا بك في متجر ملفات بيلا*\n*✹︙ملفات السورس ↓*\n*•━━━━━━ 𝑩𝑰 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝑩𝑰 ━━━━━━━•*\n *✹︙علامة تعني { ✓ } ملف مفعل*\n *✹︙علامة تعني { ✘ } ملف معطل*\n *✹︙قناة سورس بيلا ↓*\n".." *✹︙*[اضغط هنا لدخول](t.me/EE28i) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," *✹︙عذرا الملف لايدعم سورس بيلا* \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✹︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'EE28i')..')'
status  = '\n*✹︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✹︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'EE28i')..')'
status  = '\n*✹︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✹︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✹︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'EE28i')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✹︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'EE28i')..')'..'\n*✹︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,"*تم امسح ✹*")
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✹︙ العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'EE92i')..') '
...
-- vardump(data) 
BILLAdx(msg.chat_id_, msg.id_, ' *✹︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✹︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✹︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*✹︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_, t..'ٴ✹∫ٴ*•━━━━━━ 𝑩𝑰 ━━━━━━━•*ٴ✹∫○ٴ\n✹︙[⍆ BiLla 𝘛𝘦𝘈𝘮](t.me/EE28i) ')
end
...
if text == "كت" or text == "كت اتويت" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
if BILLA1_Msg then
send(msg.chat_id_, msg.id_," ✹︙"..BILLA1_Msg)
